...
const InitialLoader = ({ type }: { type: 'fullScreen' | 'fullBlock' }) => {
  return (
    <div className={styles[type]}>
      <div className={styles.preloader}>
        <svg
          className={[styles.svg, styles.sun].join(' ')}
          version="1.1"
        ...
        <svg
          className={[styles.svg, styles.cloud].join(' ')}
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
          x="0px"
        ...
        <div className={styles.text}>
          LOOKING OUTSIDE FOR YOU... <br /> ONE SEC
        </div>
      </div>
    </div>
  );
